...
<html>
	<head>
		<title>Región P'hurepecha - Pichátaro</title>
		<meta charset="utf-8" />
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="index.php" class="logo">Mi Pichátaro</a>
					<nav id="nav">
						<a href="index.php">Inicio</a>
						<a href="generic.html">Cultura</a>
						<a href="elements.html">Arte</a>
					</nav>
				</div>
			</header>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1>Zona Phurépecha: <span>Pichátaro <br />
					comunidad de artesanos con cultura e identidad propia</span></h1>
					<ul class="actions">
